  ...
  <div id = "pageContainer">
    ...
    <div id = "mainContent">
      <form action="send.php" method="POST">
        ...
        <br>
        <br>
        Body: <textarea name="body" rows="4" cols="50"></textarea>
        <span class="error">*</span>
        <br>
        <br>
        <br>
        <span style="margin-left: 10%;">Message Type:</span>
        <p><input type="radio" name="messageType" value="Question"> Question<p>
        <p><input type="radio" name="messageType" value="Comment"> Comment</p>
        <p><input type="radio" name="messageType" value="Urgent"> Urgent</p>
        <br>
